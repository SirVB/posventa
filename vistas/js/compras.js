      	...
      	success:function(respuesta){
			...
			`<div class="row" style="padding:5px 15px">
				...
				<div class="col-xs-1 cantidadProducto" style="padding-right:0px">
					<input type="text" class="form-control nuevaCantidadProducto" name="nuevaCantidadProducto" min="1" value=""  required>
				</div>
					<!-- Precio Unitario -->
...
CAMBIO EN EFECTIVO
=============================================*/
$(".formulario").on("keyup", "input#nuevoValorEfectivo", function(){
...
CAMBIO EN CHEQUE
=============================================*/
$(".formulario").on("change", "input#nuevoValorCheque", function(){
...
=============================================*/
$(".formulario").on("change", "input#nuevoValorTransferencia", function(){
...
CAMBIO EN OTRO
=============================================*/
$(".formulario").on("change", "input#nuevoValorOtro", function(){
