            ...
            <div class="box-body">
              ...
              <div class="box">
                      ...
                      <tbody>
                        ...
                        <input type="number" class="form-control input-lg" min="0" id="nuevoDescuentoVenta" name="nuevoDescuentoVenta" value="0"  required>
                            ...
                            <div class="input-group">
                              ...
                              <input type="hidden" class="form-control input-lg" min="0" id="nuevoImpuestoVenta" name="nuevoImpuestoVenta" value="0"  required>
                           ...
                           <td style="width: 50%">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" name="totalVenta" id="totalVenta">
                ...
                <div class="form-group row">
                  ...
                  <input type="text" id="listaMetodoPago" name="listaMetodoPago">
                ...
                <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
                  ...
                  <textarea class="form-control" id="nuevaObservacion" rows="2" name="nuevaObservacion"  placeholder="Obervacion (Opcional).."></textarea>
