...
class ModeloSucursales{
	...
	static public function mdlIngresarSucursal($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(nombre, region, comuna, direccion, jefe, telefono, email, bodega) VALUES (:nombre, :region, :comuna, :direccion, :jefe, :telefono, :email, :bodega)");
