	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>PENDIENTE</td>	
			...
			foreach ($ventas as $row => $item){
			 ...
			 echo utf8_decode("<tr>
				 ...
				 echo utf8_decode("</td>
					...
					<td style='border:1px solid #eee;'> $ ".number_format($item["descuento"],0,  '', '.')."</td>
					<td style='border:1px solid #eee;'> $ ".number_format($item["total_pagado"],0,  '', '.')."</td>	
					<td style='border:1px solid #eee;'> $ ".number_format($item["total_pendiente_pago"],0,  '', '.')."</td>	
